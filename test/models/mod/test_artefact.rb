...
class TestArtefact < LinkedData::TestOntologyCommon
    ...
    def test_goo_attrs_to_load
        ...
        assert_equal  [:acronym, :title, :accessRights, :creator, :URI, :versionIRI, :description, :language], attrs
    end
    ...
    def test_distributions
        ...
        assert_equal Set[:distributionId, :title, :deprecated, :hasRepresentationLanguage, :hasSyntax, :description, :created], all_distros[0].loaded_attributes
    end
